...
\Rightarrow \boxed {P=p\cdot\frac{\partial q}{\partial Q}+f(q,t)}
\end{equation}
...
\begin{equation}
F_{3}(p,Q,t), \newline (1)\; -P=\frac{\partial F_{3}}{\partial Q},\; (2)\; -q=\frac{\partial F_{3}}{\partial p}
\end{equation}
\newline
\begin{equation}
(1) \;\frac{\partial F_{3}}{\partial Q}=-p\cdot\frac{\partial q}{\partial Q}-f(q,t)
\end{equation}
\begin{equation}
F_{3}=-pq-\int_{}^{} f(Q,t)dQ+h(p,t)
\end{equation}
\begin{equation}
(2)\:\frac{\partial F_{3}}{\partial p}=-q+\frac{\partial h}{\partial p}=-q \; \Rightarrow\; h=l(t)
\end{equation}
\begin{equation}
F_{3}=-pq-\int_{}^{} f(Q,t)dQ+l(t) \Rightarrow \boxed{F_{3}=-p\cdot g(Q,t)-\int_{}^{} f(Q,t)dQ}
\end{equation}
...
\end{equation}
\begin{equation}
\mathcal{H}=-\frac{\partial F_{3}}{\partial t}\Rightarrow\boxed{\mathcal{H}=\frac{\partial (p\cdot g(Q,t))}{\partial t}+\frac{\partial (\int_{}^{}f(g(q,t),t)dQ)}{\partial t}}
\end{equation}
\item answer 4
%%%%%%%%%%%%%%%%
